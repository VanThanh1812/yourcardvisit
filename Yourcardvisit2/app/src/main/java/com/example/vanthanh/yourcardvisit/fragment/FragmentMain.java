...
public class FragmentMain extends android.app.Fragment {
    ...
    EditText edtKey;
    ArrayList<Data_Info> listCard=new ArrayList<>();
    @Nullable
    @Override
       ...
       View v=inflater.inflate(R.layout.fragment_main,null);
        ...
        btnAddcard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Contact_Card.searchCard(getActivity(),StaticValues.TAG_FRAGMENTADDCARD,edtKey.getText().toString().toLowerCase(), listCard);
